...
(function () {
    ...
    // Register hooks for indexing additional fields. Not necessary anymore because you can set
    // the fields which should be indexed in the indexer configugration ("tt_content fields which should be indexed")
    /*
